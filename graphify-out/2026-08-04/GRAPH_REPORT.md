...
## Corpus Check
- 291 files · ~128,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1430 nodes · 2548 edges · 101 communities (91 shown, 10 thin omitted)
- Extraction: 77% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 573 edges (avg confidence: 0.8)
...
- Lobby/ServerScriptService/GameService/Boot/GameBoot.luau
...
### Community 4 - "Map0_Test/ReplicatedStorage/Modules/Shared/Signal.luau"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (26): CaptureRules.Check(), CaptureTargets.AttributeFor(), CaptureTargets.IsType(), CaptureTargets.OrderedNames(), CaptureTargets.Resolve(), CaptureTargets.TypeOf(), applyModifiers(), calculateCurve() (+18 more)
...
### Community 9 - "Map0_Test/ServerScriptService/GameService/Spectate/SpectateService.luau"
Cohesion: 0.21
...
Cohesion: 0.07
Nodes (40): ensureBuilt(), QueueHud.Hide(), QueueHud.SetMessage(), CaptureTargets.Get(), MatchResultCodes.GetMessage(), ensureBuilt(), SpectateHud.Update(), buildButton() (+32 more)
...
Cohesion: 0.16
Nodes (14): MatchStates.AcceptsJoins(), MatchStates.CanTransition(), MatchStates.IsGameplayActive(), MatchStates.IsSpectateAllowed(), MatchStates.IsTerminal(), MatchStates.IsValid(), MatchStates.MonstersSpawn(), ServerRole.Is() (+6 more)
...
### Community 27 - "Lobby/ReplicatedStorage/Modules/Shared/ServerRole.luau"
Cohesion: 0.13
Nodes (5): resolve(), ServerRole.Get(), ArrivalService.Start(), handleArrival(), MatchLauncher.Launch()
...
Cohesion: 0.29
Nodes (13): MatchStates.CanTransition(), MatchStates.IsTerminal(), config(), MatchClock.Start(), runCountdown(), runEndingHold(), runPlaying(), runWaitingForPlayers() (+5 more)

### Community 32 - "Map0_Test/ReplicatedStorage/Modules/Shared/MatchStates.luau"
Cohesion: 0.12
Nodes (19): MatchStates.AcceptsJoins(), MatchStates.IsGameplayActive(), MatchStates.IsSpectateAllowed(), MatchStates.IsValid(), MatchStates.MonstersSpawn(), MatchStates.Validate(), GameBoot.Start(), guardNonReservedServer() (+11 more)
...
Cohesion: 0.09
Nodes (22): attempt(), keyFor(), LoadoutService.GetCameraId(), LoadoutService.Load(), LoadoutService.Save(), PlayerRuntimeStats.Add(), PlayerRuntimeStats.Get(), PlayerRuntimeStats.Set() (+14 more)

### Community 40 - "ServerRole.AssertLobbyServer"
Cohesion: 0.20
Nodes (13): ServerRole.AssertLobbyServer(), LaunchGate.Check(), LaunchGate.OnLaunchAborted(), LaunchGate.OnLaunched(), LaunchGate.RegisterOnLaunchAborted(), LaunchGate.RegisterOnLaunched(), LaunchGate.RegisterPrecondition(), LaunchGate.Start() (+5 more)
...
### Community 42 - "Lobby/ServerScriptService/GameService/Match/MatchCleanup.luau"
Cohesion: 0.18
Nodes (11): MatchStates.IsKitGranted(), MatchCleanup.RegisterSaveStep(), MatchCleanup.RegisterTeardownStep(), MatchCleanup.Start(), runCleanup(), runWithTimeout(), MatchParticipants.IsParticipant(), KitLifecycleHook.Start() (+3 more)
...
### Community 44 - "Map0_Test/StarterPlayerScripts/CameraToolWatcher.local.luau"
Cohesion: 0.83
...
### Community 49 - "Lobby/ServerScriptService/GameService/Match/ReturnToLobbyService.luau"
Cohesion: 0.18
...
### Community 52 - "Map0_Test/ReplicatedStorage/Modules/Shared/PlayerStates.luau"
Cohesion: 0.21
Nodes (7): PlayerStates.CanSpectate(), PlayerStates.CountsAsActive(), PlayerStates.Validate(), LobbyBoot.Start(), evaluate(), MatchEndCondition.Start(), PlayerStateService.GetAll()

### Community 53 - "Lobby/ServerScriptService/GameService/Boot/GameBoot.luau"
Cohesion: 0.29
Nodes (5): MatchStates.Validate(), PlayerStates.Validate(), GameBoot.Start(), guardNonReservedServer(), LobbyBoot.Start()

### Community 54 - "Lobby/ReplicatedStorage/Modules/Camera/CameraSession.luau"
Cohesion: 0.21
Nodes (11): CameraEffects.Apply(), CameraEffects.Clear(), CameraEffects.GetBlurAlpha(), CameraEffects.UpdateFromSpeed(), CameraSession.Enter(), CameraSession.UpdateBlur(), hideOtherGuis(), setToolLocalTransparency() (+3 more)

### Community 55 - "MatchReplicator.Start"
Cohesion: 0.13
Nodes (14): MatchStates.IsKitGranted(), MatchArrival.GetModeId(), MatchArrival.Start(), seedFrom(), MatchCleanup.RegisterTeardownStep(), MatchParticipants.All(), MatchParticipants.GetPresent(), MatchParticipants.IsParticipant() (+6 more)
...
Cohesion: 0.14
Nodes (12): ServerRole.AssertGameServer(), MatchManager.GetElapsed(), MatchManager.Start(), buildPerPlayer(), MatchResultBuilder.Build(), MatchResultBuilder.RegisterContributor(), MatchResultBuilder.Start(), MatchRosterHook.Start() (+4 more)
...
Cohesion: 0.11
Nodes (19): resolve(), ServerRole.AssertGameServer(), ServerRole.Get(), ServerRole.Is(), MatchCleanup.RegisterSaveStep(), MatchCleanup.Start(), runCleanup(), runWithTimeout() (+11 more)

### Community 61 - "Map0_Test/ServerScriptService/GameService/Match/MatchStats.luau"
Cohesion: 0.33
Nodes (6): MatchGrade.Evaluate(), ensureCaptureRow(), MatchStats.Start(), onAwarded(), reset(), survivedSeconds()

### Community 62 - "Lobby/ReplicatedStorage/Modules/Camera/CameraState.luau"
Cohesion: 0.24
...
### Community 98 - "Lobby/ServerScriptService/GameService/Match/MatchManager.luau"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (10): ArrivalService.Start(), handleArrival(), MatchLauncher.Launch(), MatchLauncher.Start(), attemptReturn(), buildTeleportData(), handleInitFailed(), handleReturnRequest() (+2 more)
...
### Community 102 - "Map0_Test/ReplicatedStorage/Modules/Camera/CameraState.luau"
Cohesion: 0.24
Nodes (5): CameraState.GetWalkSpeedMultiplier(), CameraState.SetInCamera(), CameraState.SetStable(), fireListeners(), fireStableListeners()

### Community 104 - "Lobby/ReplicatedStorage/Modules/Camera/CameraTouchHud.luau"
Cohesion: 0.38
Nodes (3): buildCircleButton(), CameraTouchHud.Init(), ensureBuilt()

### Community 105 - "MonsterService.Spawn"
Cohesion: 0.27
...
- **Why does `RewardService.AwardFromCapture()` connect `Lobby/ServerScriptService/GameService/Reward/RewardService.luau` to `Lobby/ServerScriptService/GameService/Reward/CaptureGuard.luau`, `Lobby/ReplicatedStorage/Modules/UI/MatchReceipt.luau`?**
