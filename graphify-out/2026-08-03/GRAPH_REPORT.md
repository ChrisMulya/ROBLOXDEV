...
## Corpus Check
- 276 files · ~118,092 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1288 nodes · 2227 edges · 98 communities (90 shown, 8 thin omitted)
- Extraction: 77% EXTRACTED · 23% INFERRED · 0% AMBIGUOUS · INFERRED: 503 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `161c9056`
...
- Lobby/ServerScriptService/GameService/Lobby/PartyService.luau
- onCharacterAdded
...
- `PlayerStateService.Set()` --calls--> `PlayerStates.IsValid()`  [INFERRED]
  Lobby/ServerScriptService/GameService/PlayerState/PlayerStateService.luau → Lobby/ReplicatedStorage/Modules/Shared/PlayerStates.luau
...
### Community 0 - "Lobby/ReplicatedStorage/Modules/Camera/CameraToolController.luau"
Cohesion: 0.20
...
Cohesion: 0.17
Nodes (15): PlayerStates.CanTransition(), DeathPolicy.Get(), bindCharacter(), DeathService.Start(), onCharacterAdded(), onHumanoidDied(), bindCharacter(), LobbyDeathPolicy.Start() (+7 more)

### Community 4 - "Map0_Test/ReplicatedStorage/Modules/Shared/Remotes.luau"
Cohesion: 0.06
Nodes (27): ShotResultCodes.GetMessage(), PlayerStates.CanControlCharacter(), Remotes.Get(), ArrivalService.Start(), handleArrival(), MatchParticipants.GetPresent(), ensureMatchInfoFolder(), MatchReplicator.Start() (+19 more)
...
Cohesion: 0.12
Nodes (25): LoadoutService.ClearSession(), RewardTypes.Get(), RewardTypes.Persistent(), RewardTypes.RunScoped(), RemoveAllSlot.ClearPlayerTools(), onPlayerAdded(), onPlayerRemoving(), checkProgression() (+17 more)
...
Cohesion: 0.13
Nodes (23): LoadoutService.ClearSession(), RewardTypes.Get(), RewardTypes.Persistent(), RewardTypes.RunScoped(), onPlayerAdded(), onPlayerRemoving(), checkProgression(), onLaunched() (+15 more)
...
Cohesion: 0.20
Nodes (13): MatchArrival.GetModeId(), MatchArrival.Start(), seedFrom(), config(), MatchClock.Start(), runCountdown(), runEndingHold(), runPlaying() (+5 more)

### Community 32 - "Map0_Test/ReplicatedStorage/Modules/Shared/MatchStates.luau"
Cohesion: 0.19
Nodes (14): MatchStates.AcceptsJoins(), MatchStates.CanTransition(), MatchStates.IsGameplayActive(), MatchStates.IsScoringActive(), MatchStates.IsSpectateAllowed(), MatchStates.IsTerminal(), MatchStates.IsValid(), MatchManager.Abort() (+6 more)
...
Cohesion: 0.13
Nodes (20): MatchConfig.Get(), Remotes.Get(), LaunchGate.Check(), LaunchGate.OnLaunched(), LaunchGate.RegisterOnLaunched(), LaunchGate.RegisterPrecondition(), LaunchGate.Start(), dequeueUnits() (+12 more)
...
Cohesion: 0.10
Nodes (26): MatchConfig.Get(), LaunchGate.Check(), LaunchGate.OnLaunched(), LaunchGate.RegisterOnLaunched(), LaunchGate.RegisterPrecondition(), LaunchGate.Start(), onPlayerRemoving(), PartyService.GetLeader() (+18 more)
...
### Community 41 - "ServerStorage/ProfileStore.luau"
Cohesion: 0.12
Nodes (4): AcquireRunnerThreadAndCallEventHandler(), ProfileStore:VersionQuery(), ProfileVersionQuery.New(), RunEventHandlerInFreeThread()

### Community 42 - "MatchReplicator.Start"
Cohesion: 0.24
Nodes (7): ensureMatchInfoFolder(), MatchReplicator.Start(), buildPerPlayer(), MatchResultBuilder.Build(), MatchResultBuilder.RegisterContributor(), MatchResultBuilder.Start(), RewardResultHook.Start()
...
### Community 44 - "MatchManager.RequestTransition"
Cohesion: 0.15
Nodes (19): PlayerStates.CountsAsActive(), MatchArrival.GetModeId(), MatchArrival.Start(), seedFrom(), config(), MatchClock.Start(), runCountdown(), runEndingHold() (+11 more)

### Community 45 - "Map0_Test/ReplicatedStorage/Modules/Shared/ServerRole.luau"
Cohesion: 0.16
Nodes (14): resolve(), ServerRole.AssertGameServer(), ServerRole.AssertLobbyServer(), ServerRole.Get(), ServerRole.Is(), MatchCleanup.RegisterSaveStep(), MatchCleanup.Start(), runCleanup() (+6 more)
...
### Community 49 - "Map0_Test/ServerScriptService/GameService/PlayerState/PlayerStateService.luau"
Cohesion: 0.19
Nodes (14): PlayerStates.CanTransition(), DeathPolicy.Get(), bindCharacter(), DeathService.Start(), onCharacterAdded(), onHumanoidDied(), bindCharacter(), LobbyDeathPolicy.Start() (+6 more)
...
Cohesion: 0.20
Nodes (11): MatchStates.IsKitGranted(), ServerRole.AssertGameServer(), MatchCleanup.RegisterSaveStep(), MatchCleanup.RegisterTeardownStep(), MatchCleanup.Start(), runCleanup(), runWithTimeout(), MatchParticipants.IsParticipant() (+3 more)
...
### Community 61 - "Map0_Test/ReplicatedStorage/Modules/Shared/PlayerStates.luau"
Cohesion: 0.15
Nodes (11): MatchStates.Validate(), PlayerStates.CanSpectate(), PlayerStates.CountsAsActive(), PlayerStates.IsValid(), PlayerStates.Validate(), GameBoot.Start(), guardNonReservedServer(), LobbyBoot.Start() (+3 more)

### Community 62 - "Lobby/ReplicatedStorage/Modules/Shared/PlayerStates.luau"
Cohesion: 0.19
Nodes (9): PlayerStates.CanControlCharacter(), PlayerStates.CanSpectate(), PlayerStates.IsValid(), MatchParticipants.GetPresent(), PlayerStateService.Get(), indexOf(), SpectateTargets.GetValidTargets(), SpectateTargets.SelectNext() (+1 more)

### Community 63 - "Lobby/ServerScriptService/GameService/Spectate/SpectateService.luau"
Cohesion: 0.40
Nodes (12): assignBest(), fireSync(), onMatchStateChanged(), onPlayerRemoving(), onPlayerStateChanged(), onSpectateRequest(), reassignSpectatorsWatching(), SpectateService.GetTarget() (+4 more)

### Community 64 - "Map0_Test/ServerScriptService/GameService/Match/ReturnToLobbyService.luau"
Cohesion: 0.29
Nodes (7): MatchLauncher.Launch(), MatchLauncher.Start(), attemptReturn(), buildTeleportData(), handleInitFailed(), ReturnToLobbyService.ReturnAll(), ReturnToLobbyService.Start()
...
### Community 67 - "Lobby/ReplicatedStorage/Modules/Camera/CameraState.luau"
Cohesion: 0.28
Nodes (4): CameraState.SetInCamera(), CameraState.SetStable(), fireListeners(), fireStableListeners()

### Community 94 - "Lobby/ServerScriptService/GameService/Lobby/PartyService.luau"
Cohesion: 0.42
Nodes (8): onPlayerRemoving(), PartyService.GetLeader(), PartyService.GetParty(), PartyService.IsLeader(), PartyService.Join(), PartyService.Leave(), PartyService.Start(), removeFromCurrentParty()

### Community 97 - "onCharacterAdded"
Cohesion: 0.40
Nodes (5): MatchStates.IsKitGranted(), MatchCleanup.RegisterTeardownStep(), KitLifecycleHook.Start(), onCharacterAdded(), StartGameService.ResetKit()
