...
## Corpus Check
- 93 files · ~33,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 429 nodes · 644 edges · 34 communities (28 shown, 6 thin omitted)
...
### Community 17 - "PurchaseNotification.luau"
Cohesion: 0.53
Nodes (4): SoundIds.GetSoundId(), playSound(), PurchaseNotification.Handle(), showText()
...
Cohesion: 0.07
Nodes (8): ShotResultCodes.GetMessage(), UIBuilder.CreateScreenGui(), CameraSessionTracker.IsInCamera(), ensureBuilt(), showCurrencyUI(), closeShop(), openShop(), buildHitText()
...
- **Why does `RewardService.AwardFromCapture()` connect `RewardService.luau` to `CameraStats.luau`?**
