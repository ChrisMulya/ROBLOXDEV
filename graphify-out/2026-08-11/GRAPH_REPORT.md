# Graph Report - ROBLOX-DEV  (2026-08-11)

## Corpus Check
- 434 files · ~248,225 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2404 nodes · 4112 edges · 205 communities (181 shown, 24 thin omitted)
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 820 edges (avg confidence: 0.8)
...
- Lobby/ServerScriptService/GameService/MatchTime/MatchTimeService.luau
- Map0_Test/ServerScriptService/GameService/MatchTime/MatchTimeService.luau
...
- Pickup Registry / Pickup Prompt (Lobby)
...
- Lobby/ServerScriptService/GameService/Monster/Components/Navigation.luau
- CameraSession.Enter
...
- Map0_Test/ServerScriptService/GameService/Boot/GameBoot.luau
...
- StarterPlayerScripts/MobileSprintButton.local.luau
- Map0_Test/ReplicatedStorage/Modules/Loadout/LoadoutService.luau
- Map0_Test/ServerScriptService/GameService/Monster/Components/Perception.luau
...
- Map0_Test/ServerScriptService/GameService/Monster/Components/Evolution.luau
- Map0_Test/ServerScriptService/GameService/Monster/States/Chase.luau
- CheckXpMigration.luau
- CLAUDE.md
- CameraInventory
- Lobby/ServerScriptService/GameService/Monster/Locomotion/HumanoidPathLocomotion.luau
- Lobby/ServerScriptService/GameService/Monster/Sensors/VisionSensor.luau
- Lobby/ServerScriptService/GameService/Monster/States/Check.luau
- Map0_Test/ServerScriptService/GameService/Monster/Locomotion/HumanoidPathLocomotion.luau
- Map0_Test/ServerScriptService/GameService/Monster/Sensors/VisionSensor.luau
- Map0_Test/ServerScriptService/GameService/Monster/States/Check.luau
- RewardCalculator
- Work Modes
- MatchArrival
...
- PickupService
- GameService/Player/CharacterMovementService.luau
- MatchClock
...
- Lobby/ServerScriptService/GameService/Monster/MonsterBus.luau
- PhotoScoring module
- SearchPointSelector.Select
- Lobby/ServerScriptService/GameService/Monster/Components/init.luau
- Map0_Test/ServerScriptService/GameService/Monster/MonsterBus.luau
- Map0_Test/ServerScriptService/GameService/Monster/Components/init.luau
- PhotoCapture.luau
- ServerRole
...
- GenerateGameMirror tooling (deleted)
- MatchConfig
- MatchReplicator
...
1. `ServerRole.AssertGameServer()` - 30 edges
2. `ServerRole.AssertGameServer()` - 29 edges
3. `CameraSession.Enter()` - 23 edges
4. `CameraSession.Enter()` - 18 edges
5. `ensureBuilt()` - 16 edges
6. `ensureBuilt()` - 16 edges
7. `Remotes.Get()` - 15 edges
8. `Remotes.Get()` - 14 edges
9. `MonsterConfig.Get()` - 12 edges
...
- `MonsterInstance:SetStage()` --calls--> `MonsterConfig.Get()`  [INFERRED]
  Lobby/ServerScriptService/GameService/Monster/MonsterInstance.luau → Lobby/ReplicatedStorage/Modules/Monster/MonsterConfig.luau
...
- **Match-hour evolution dispatch chain** — plans_evolutionplan_matchtimeservice, plans_evolutionplan_matchtimeevents, plans_evolutionplan_monsterregistry, plans_evolutionplan_evolve, plans_evolutionplan_evolution_apply [EXTRACTED 1.00]
- **Evolution tier mutation-set fields** — plans_evolutionplan_stats_multipliers, plans_evolutionplan_capabilities, plans_evolutionplan_states, plans_evolutionplan_aggression, plans_evolutionplan_perception, plans_evolutionplan_abilities, plans_evolutionplan_presentation [EXTRACTED 1.00]
- **Evolution apply to client presentation flow** — plans_evolutionplan_evolution_apply, plans_evolutionplan_evolved_bus_event, plans_evolutionplan_presentation, plans_evolutionplan_evolutiontier_attribute [EXTRACTED 1.00]
...
Cohesion: 0.11
Nodes (34): MatchConfig.Get(), LaunchGate.Check(), LaunchGate.OnLaunched(), onPlayerRemoving(), PartyService.GetLeader(), PartyService.GetParty(), PartyService.IsLeader(), PartyService.Join() (+26 more)
...
Cohesion: 0.05
Nodes (36): MatchSchedule.Get(), MatchSchedule.Validate(), getMatchInfo(), MatchTimeClient.GetAnchors(), MatchTimeClient.GetHour(), MatchTimeClient.GetHourText(), MatchTimeClient.GetPhase(), MatchTimeClient.GetProgress() (+28 more)

### Community 3 - "Map0_Test/ServerScriptService/GameService/MatchTime/MatchTimeService.luau"
Cohesion: 0.05
Nodes (38): MatchSchedule.Get(), MatchSchedule.Validate(), getMatchInfo(), MatchTimeClient.GetAnchors(), MatchTimeClient.GetHour(), MatchTimeClient.GetHourText(), MatchTimeClient.GetPhase(), MatchTimeClient.GetProgress() (+30 more)

### Community 5 - "Map0_Test/ServerScriptService/GameService/Player/CharacterMovementService.luau"
Cohesion: 0.07
Nodes (21): FlashlightAim.GetPose(), applyBudget(), CharacterMovementService.IsSprinting(), CharacterMovementService.Start(), onCharacterAdded(), onSprintRequest(), onStateChanged(), setupPlayer() (+13 more)
...
Cohesion: 0.09
Nodes (24): CaptureRules.Check(), CaptureTargets.AttributeFor(), CaptureTargets.IsType(), CaptureTargets.Resolve(), CaptureTargets.TypeOf(), applyModifiers(), calculateCurve(), calculateFlatRoll() (+16 more)

### Community 10 - "Map0_Test/ServerScriptService/GameService/Reward/RewardService.luau"
Cohesion: 0.09
Nodes (24): CaptureRules.Check(), CaptureTargets.AttributeFor(), CaptureTargets.IsType(), CaptureTargets.Resolve(), CaptureTargets.TypeOf(), applyModifiers(), calculateCurve(), calculateFlatRoll() (+16 more)
...
Cohesion: 0.09
Nodes (22): resolve(), ServerRole.AssertGameServer(), ServerRole.Get(), ServerRole.Is(), MatchCleanup.RegisterSaveStep(), MatchCleanup.RegisterTeardownStep(), MatchCleanup.Start(), runCleanup() (+14 more)

### Community 13 - "Pickup Registry / Pickup Prompt (Lobby)"
Cohesion: 0.12
Nodes (21): PickupResultCodes.GetMessage(), PickupTypes.Get(), PickupTypes.TypeOf(), PickupHandlers.Get(), anchorPartOf(), PickupPrompt.Clear(), PickupPrompt.Disable(), PickupPrompt.Enable() (+13 more)

### Community 14 - "Lobby/ReplicatedStorage/Modules/Shared/MatchStates.luau"
Cohesion: 0.11
Nodes (22): MatchStates.AcceptsJoins(), MatchStates.IsKitGranted(), MatchStates.IsScoringActive(), MatchStates.IsSpectateAllowed(), MatchStates.IsTerminal(), MatchStates.IsValid(), MatchStates.RespawnsOnDeath(), MatchManager.Get() (+14 more)

### Community 15 - "Map0_Test/ReplicatedStorage/Modules/Shared/ServerRole.luau"
Cohesion: 0.09
Nodes (25): Remotes.Get(), resolve(), ServerRole.AssertGameServer(), ServerRole.Get(), ServerRole.Is(), MatchCleanup.RegisterSaveStep(), MatchCleanup.RegisterTeardownStep(), MatchCleanup.Start() (+17 more)

### Community 16 - "Lobby/ServerScriptService/GameService/PlayerState/PlayerStateService.luau"
Cohesion: 0.16
...
### Community 18 - "Map0_Test/ServerScriptService/GameService/Monster/States/Patrol.luau"
Cohesion: 0.28
Nodes (14): deferPoint(), ensureRouteTarget(), maybeDivert(), memoryFor(), Patrol.Enter(), Patrol.Update(), patrolCfg(), pauseChanceFor() (+6 more)

### Community 19 - "Lobby/ReplicatedStorage/Modules/UI/MatchReceipt.luau"
Cohesion: 0.06
Nodes (47): ensureBuilt(), MatchTimeHud.Hide(), MatchTimeHud.Update(), ensureBuilt(), QueueHud.Hide(), QueueHud.SetMessage(), CaptureTargets.Get(), CaptureTargets.OrderedNames() (+39 more)
...
### Community 21 - "Map0_Test/ReplicatedStorage/Modules/Shared/Remotes.luau"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (13): Remotes.Get(), CameraSessionTracker.IsInCamera(), CameraSessionTracker.Start(), ArrivalService.Start(), handleArrival(), fireResultToPad(), attemptReturn(), buildTeleportData() (+5 more)

### Community 23 - "Lobby/ServerScriptService/GameService/Spectate/SpectateService.luau"
Cohesion: 0.16
Nodes (21): PlayerStates.CanControlCharacter(), PlayerStates.CanSpectate(), PlayerStates.Validate(), LobbyBoot.Start(), PlayerStateService.Get(), assignBest(), fireSync(), onMatchStateChanged() (+13 more)

### Community 24 - "Map0_Test/ServerScriptService/GameService/Spectate/SpectateService.luau"
Cohesion: 0.24
...
Cohesion: 0.19
Nodes (14): collect(), expand(), MonsterCapabilities.ComponentsFor(), MonsterCapabilities.Resolve(), MonsterCapabilities.StatesFor(), MonsterCapabilities.StimuliFor(), MonsterCapabilities.Validate(), mergeStages() (+6 more)
...
Cohesion: 0.23
Nodes (8): mergeStages(), MonsterConfig.All(), MonsterConfig.Validate(), resolveStats(), everyTier(), MonsterFramework.Start(), reportPlannedComponents(), MonsterRegistry.Start()

### Community 28 - "Map0_Test/ReplicatedStorage/Modules/Shared/PlayerStates.luau"
Cohesion: 0.12
...
### Community 29 - "Map0_Test/ServerScriptService/Vendor/ProfileStore.luau"
Cohesion: 0.10
Nodes (4): AcquireRunnerThreadAndCallEventHandler(), ProfileStore:VersionQuery(), ProfileVersionQuery.New(), RunEventHandlerInFreeThread()
...
Cohesion: 0.11
Nodes (26): MatchStates.AcceptsJoins(), MatchStates.CanTransition(), MatchStates.IsGameplayActive(), MatchStates.IsKitGranted(), MatchStates.IsScoringActive(), MatchStates.IsSpectateAllowed(), MatchStates.IsTerminal(), MatchStates.IsValid() (+18 more)

### Community 33 - "ensureBuilt"
Cohesion: 0.26
Nodes (10): buildButton(), buildButtonHolder(), buildHeader(), DeathScreen.Hide(), DeathScreen.Show(), ensureBuilt(), renderButtons(), UIBuilder.CreateBackdrop() (+2 more)
...
### Community 35 - "Map0_Test/ReplicatedStorage/Modules/CameraShelf/CameraShelfGui.luau"
Cohesion: 0.17
Nodes (14): CameraStats.GetOrderedIds(), buildCameraRow(), buildCloseButton(), buildListHolder(), buildMessageLabel(), buildPanel(), buildTitle(), CameraShelfGui.Build() (+6 more)

### Community 36 - "Lobby/ServerScriptService/GameService/Monster/MonsterInstance.luau"
Cohesion: 0.11
Nodes (4): Brain.new(), buildComponents(), MonsterInstance.new(), MonsterInstance:SetStage()

### Community 37 - "Map0_Test/ReplicatedStorage/Modules/Camera/CameraState.luau"
Cohesion: 0.13
Nodes (12): CameraState.GetFOV(), CameraState.GetFOVChangeRate(), CameraState.GetStable(), CameraState.GetWalkSpeedMultiplier(), CameraState.OnStableChanged(), CameraState.SetInCamera(), CameraState.SetMovementSettings(), CameraState.SetStable() (+4 more)

### Community 38 - "Map0_Test/ServerScriptService/GameService/Monster/MonsterInstance.luau"
Cohesion: 0.17
Nodes (5): Brain.new(), StateMachine.new(), buildComponents(), MonsterInstance.new(), MonsterInstance:SetStage()
...
### Community 40 - "Lobby/StarterPlayerScripts/MobileSprintButton.local.luau"
Cohesion: 0.21
Nodes (8): TouchSession.IsActive(), fallbackHome(), getControlModule(), getStickMagnitude(), isTouchSession(), positionAtHome(), toggleArm(), tryArm()
...
Cohesion: 0.20
Nodes (9): TouchSession.IsActive(), fallbackHome(), getControlModule(), getStickMagnitude(), hasStaminaToStart(), isTouchSession(), positionAtHome(), toggleArm() (+1 more)

### Community 44 - "Map0_Test/ServerScriptService/GameService/Match/MatchClock.luau"
Cohesion: 0.13
Nodes (20): MatchArrival.GetModeId(), MatchArrival.Start(), seedFrom(), config(), MatchClock.GetEndingDeadline(), MatchClock.Start(), runCountdown(), runEndingHold() (+12 more)
...
### Community 52 - "Lobby/ReplicatedStorage/Modules/Camera/CameraStats.luau"
Cohesion: 0.15
...
### Community 57 - "Lobby/ReplicatedStorage/Modules/Shared/Signal.luau"
Cohesion: 0.15
...
### Community 59 - "Lobby/ReplicatedStorage/Modules/Camera/CameraToolController.luau"
Cohesion: 0.33
...
### Community 62 - "MonsterConfig.Get"
Cohesion: 0.38
...
### Community 63 - "Map0_Test/ServerScriptService/GameService/Monster/PatrolGraph.luau"
Cohesion: 0.29
Nodes (8): matchesMonster(), PatrolGraph.HasPatrolPoints(), PatrolGraph.Nearest(), PatrolGraph.PointsWithin(), PatrolGraph.SearchPointsWithin(), PatrolGraph.Start(), tryAdd(), Patrol.Score()

### Community 65 - "CameraSession.Enter"
Cohesion: 0.22
Nodes (17): CameraEffects.Apply(), CameraEffects.Clear(), CameraSession.Enter(), hideOtherGuis(), setToolLocalTransparency(), CameraStats.GetBlurSettings(), CameraStats.GetColorGradeSettings(), CameraStats.GetEffectsSettings() (+9 more)

### Community 66 - "Map0_Test/ServerScriptService/GameService/Reward/RewardLedger.luau"
Cohesion: 0.30
...
### Community 67 - "Map0_Test/ReplicatedStorage/Modules/Pickup/PickupVisualsController.luau"
Cohesion: 0.33
Nodes (6): PickupVisuals.Apply(), PickupVisuals.Clear(), PickupVisuals.Step(), clearAllVisible(), considerInstance(), unregister()

### Community 68 - "Map0_Test/ServerScriptService/GameService/CameraShelf/CameraInventory.luau"
Cohesion: 0.36
...
### Community 71 - "Lobby/ServerScriptService/GameService/Monster/States/Chase.luau"
Cohesion: 0.39
Nodes (5): Chase.Score(), Chase.Update(), committedUtility(), pursuitAnchor(), pursuitTarget()

### Community 72 - "ServerRole.AssertLobbyServer"
Cohesion: 0.19
Nodes (12): ServerRole.AssertLobbyServer(), LaunchGate.OnLaunchAborted(), LaunchGate.RegisterOnLaunchAborted(), LaunchGate.RegisterOnLaunched(), LaunchGate.RegisterPrecondition(), LaunchGate.Start(), handleInitFailed(), MatchLauncher.Launch() (+4 more)

### Community 73 - "Map0_Test/ServerScriptService/GameService/Boot/GameBoot.luau"
Cohesion: 0.20
Nodes (7): MatchStates.Validate(), GameBoot.Start(), guardNonReservedServer(), LaunchGate.OnLaunchAborted(), handleInitFailed(), MatchLauncher.Launch(), MatchLauncher.Start()
...
### Community 75 - "FirstPersonCrosshair.local.luau"
Cohesion: 0.32
...
Cohesion: 0.22
Nodes (4): Perception:_absorb(), Perception.new(), trimStimuli(), Sensors.ForStimulus()

### Community 78 - "GameBoot"
Cohesion: 0.20
...
### Community 79 - "CameraShotHandler.legacy.luau"
Cohesion: 0.22
Nodes (10): CameraShotHandler.legacy.luau, CaptureGuard.ValidateShot, FlashEvents (server, no subscribers), CameraShotHandler.legacy.luau, Client-supplied origin exploit, PlayerRewards.Award, CaptureContext shape, Client-supplied origin exploit (+2 more)

### Community 80 - "StarterPlayerScripts/MobileSprintButton.local.luau"
Cohesion: 0.20
Nodes (9): CameraState, ScreenGui DisplayOrder registry, G16 — DynamicThumbstickFrame occupies bottom-left, G1 — StarterGui LocalScripts re-run on respawn, StarterPlayerScripts/MobileSprintButton.local.luau, Playermovementcontroller, ReplicatedStorage/Modules/Movement/SprintIntent.luau, Tap-to-arm mobile sprint (+1 more)

### Community 81 - "Map0_Test/ReplicatedStorage/Modules/Loadout/LoadoutService.luau"
Cohesion: 0.31
...
### Community 82 - "Map0_Test/ServerScriptService/GameService/Monster/Components/Perception.luau"
Cohesion: 0.22
Nodes (4): Perception:_absorb(), Perception.new(), trimStimuli(), Sensors.ForStimulus()

### Community 84 - "Lobby/ReplicatedStorage/Modules/Camera/CameraTouchHud.luau"
Cohesion: 0.39
...
### Community 85 - "Lobby/ReplicatedStorage/Modules/PlayerRuntimeStats.luau"
Cohesion: 0.18
Nodes (4): CameraState.GetWalkSpeedMultiplier(), PlayerRuntimeStats.Get(), hasStaminaToStart(), setupCharacter()
...
Cohesion: 0.24
Nodes (7): MatchStates.IsGameplayActive(), MonsterRegistry.Add(), MonsterRegistry.ForEach(), MonsterRegistry.Remove(), MonsterRegistry.Start(), gameplayActive(), MonsterScheduler.Start()
...
### Community 92 - "Map0_Test/ReplicatedStorage/Modules/Camera/CameraTouchHud.luau"
Cohesion: 0.39
Nodes (7): buildCircleButton(), CameraTouchHud.Init(), CameraTouchHud.SetInCamera(), CameraTouchHud.Show(), ensureBuilt(), ensureReady(), isTouchDevice()

### Community 93 - "Map0_Test/ReplicatedStorage/Modules/PlayerRuntimeStats.luau"
Cohesion: 0.29
Nodes (3): PlayerRuntimeStats.Get(), PlayerStats.Get(), updateBar()
...
### Community 97 - "Map0_Test/ServerScriptService/GameService/Monster/States/Chase.luau"
Cohesion: 0.39
Nodes (5): Chase.Score(), Chase.Update(), committedUtility(), pursuitAnchor(), pursuitTarget()

### Community 98 - "CheckXpMigration.luau"
Cohesion: 0.39
...
### Community 100 - "CameraInventory"
Cohesion: 0.25
Nodes (8): Roblox Project Facts, LoadoutService, CameraInventory, CameraSessionTracker InCamera flag, G12 — Spectate uses CameraType.Custom, not Scriptable, Security boundary — client-reported flags are UX only, CameraShelfSwap, CameraSessionTracker module-scope side effects

### Community 102 - "Lobby/ServerScriptService/GameService/Monster/Locomotion/HumanoidPathLocomotion.luau"
Cohesion: 0.27
Nodes (6): flatDistance(), hasJumpWaypoint(), HumanoidPathLocomotion:_advanceWaypoints(), HumanoidPathLocomotion:_computeAsync(), HumanoidPathLocomotion:MoveTo(), pathLength()

### Community 103 - "Lobby/ServerScriptService/GameService/Monster/Sensors/VisionSensor.luau"
Cohesion: 0.36
Nodes (4): aimPosition(), eyePosition(), isBlocked(), VisionSensor:Sense()

### Community 104 - "Lobby/ServerScriptService/GameService/Monster/States/Check.luau"
Cohesion: 0.41
Nodes (11): beginInvestigation(), beginLinger(), Check.Enter(), Check.Exit(), Check.Score(), Check.Update(), cooldownDuration(), freshnessWindow() (+3 more)

### Community 106 - "Map0_Test/ServerScriptService/GameService/Monster/Locomotion/HumanoidPathLocomotion.luau"
Cohesion: 0.27
Nodes (6): flatDistance(), hasJumpWaypoint(), HumanoidPathLocomotion:_advanceWaypoints(), HumanoidPathLocomotion:_computeAsync(), HumanoidPathLocomotion:MoveTo(), pathLength()

### Community 107 - "Map0_Test/ServerScriptService/GameService/Monster/Sensors/VisionSensor.luau"
Cohesion: 0.36
Nodes (4): aimPosition(), eyePosition(), isBlocked(), VisionSensor:Sense()

### Community 108 - "Map0_Test/ServerScriptService/GameService/Monster/States/Check.luau"
Cohesion: 0.41
Nodes (11): beginInvestigation(), beginLinger(), Check.Enter(), Check.Exit(), Check.Score(), Check.Update(), cooldownDuration(), freshnessWindow() (+3 more)

### Community 109 - "RewardCalculator"
Cohesion: 0.25
...
### Community 116 - "QueueService.luau"
Cohesion: 0.38
...
### Community 118 - "UIBuilder.CreateScreenGui"
Cohesion: 0.20
Nodes (11): ensureBuilt(), MatchTimeHud.Hide(), MatchTimeHud.Update(), ensureBuilt(), QueueHud.Hide(), QueueHud.SetMessage(), UIBuilder.CreateScreenGui(), UIBuilder.GetPlayerGui() (+3 more)
...
Cohesion: 0.53
Nodes (4): memoryFor(), Wander.Enter(), Wander.Exit(), Wander.Update()

### Community 123 - "PickupService"
Cohesion: 0.33
...
### Community 124 - "GameService/Player/CharacterMovementService.luau"
Cohesion: 0.33
...
### Community 126 - "Map0_Test/ReplicatedStorage/Modules/Shared/Signal.luau"
Cohesion: 0.15
...
### Community 128 - "LaunchGate.OnLaunched"
Cohesion: 0.33
...
### Community 141 - "Map0_Test/ServerScriptService/GameService/Player/StartGame.luau"
Cohesion: 0.70
Nodes (4): LoadoutService.GetCameraId(), createEmptySlot(), giveStarterCamera(), StartGameService.GivePlayerStarterKit()

### Community 142 - "Map0_Test/ReplicatedStorage/Modules/Spectate/SpectateHud.luau"
Cohesion: 0.70
Nodes (4): ensureBuilt(), setBackpackVisible(), SpectateHud.Hide(), SpectateHud.Update()

### Community 143 - "Lobby/ServerScriptService/GameService/MatchTime/MatchTimeReplicator.luau"
Cohesion: 0.53
...
### Community 152 - "SearchPointSelector.Select"
Cohesion: 0.70
Nodes (4): bearingAlignment(), investigationConfig(), SearchPointSelector.Select(), withinCone()

### Community 156 - "PhotoCapture.luau"
Cohesion: 0.67
...
### Community 157 - "ServerRole"
Cohesion: 0.67
Nodes (3): GameBoot, LobbyBoot, ServerRole

### Community 161 - "Lobby/ServerScriptService/GameService/Match/MatchManager.luau"
Cohesion: 0.16
Nodes (20): MatchStates.CanTransition(), PlayerStates.CountsAsActive(), MatchArrival.GetModeId(), MatchArrival.Start(), seedFrom(), config(), MatchClock.GetEndingDeadline(), MatchClock.Start() (+12 more)
...
### Community 164 - "Map0_Test/ReplicatedStorage/Modules/Flash/FlashRenderers/ScreenFlashRenderer.luau"
Cohesion: 0.57
Nodes (6): cancelTween(), ensureGui(), ScreenFlashRenderer.FadeOut(), ScreenFlashRenderer.HideInstant(), ScreenFlashRenderer.Play(), ScreenFlashRenderer.ShowSolid()

### Community 165 - "Map0_Test/ReplicatedStorage/Modules/Flash/FlashRenderers/WorldLightRenderer.luau"
Cohesion: 0.46
...
### Community 167 - "SearchPointSelector.Select"
Cohesion: 0.70
Nodes (4): bearingAlignment(), investigationConfig(), SearchPointSelector.Select(), withinCone()
...
## Knowledge Gaps
- **78 isolated node(s):** `Graphify workflow rule`, `Planning Mode`, `Bug Fix Mode`, `Audit Mode`, `Reporting format` (+73 more)
...
- **Why does `ServerRole.AssertGameServer()` connect `Lobby/ReplicatedStorage/Modules/Shared/ServerRole.luau` to `Lobby/ServerScriptService/GameService/Match/MatchManager.luau`, `Lobby/ServerScriptService/GameService/MatchTime/MatchTimeService.luau`, `Lobby/ServerScriptService/GameService/Reward/RewardService.luau`, `Pickup Registry / Pickup Prompt (Lobby)`, `Lobby/ReplicatedStorage/Modules/Shared/MatchStates.luau`, `Lobby/ServerScriptService/GameService/MatchTime/MatchTimeReplicator.luau`, `Lobby/ServerScriptService/GameService/Monster/EncounterDirector.luau`, `Lobby/ReplicatedStorage/Modules/Shared/Remotes.luau`, `Lobby/ReplicatedStorage/Modules/Shared/Signal.luau`, `Lobby/ReplicatedStorage/Modules/Monster/MonsterConfig.luau`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `ServerRole.AssertGameServer()` connect `Map0_Test/ReplicatedStorage/Modules/Shared/ServerRole.luau` to `Map0_Test/ReplicatedStorage/Modules/Shared/MatchStates.luau`, `Map0_Test/ServerScriptService/GameService/MatchTime/MatchTimeService.luau`, `onPromptTriggered`, `Map0_Test/ServerScriptService/GameService/Boot/GameBoot.luau`, `Map0_Test/ServerScriptService/GameService/Reward/RewardService.luau`, `Map0_Test/ServerScriptService/GameService/Match/MatchClock.luau`, `Map0_Test/ServerScriptService/GameService/Monster/EncounterDirector.luau`, `Map0_Test/ReplicatedStorage/Modules/Shared/Remotes.luau`, `Map0_Test/ReplicatedStorage/Modules/Monster/MonsterConfig.luau`, `Map0_Test/ReplicatedStorage/Modules/Shared/PlayerStates.luau`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `RewardCleanupHook.Start()` connect `Lobby/ReplicatedStorage/Modules/Shared/ServerRole.luau` to `Lobby/ServerScriptService/GameService/Reward/RewardStore.luau`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Are the 28 inferred relationships involving `ServerRole.AssertGameServer()` (e.g. with `GameBoot.Start()` and `MatchArrival.Start()`) actually correct?**
  _`ServerRole.AssertGameServer()` has 28 INFERRED edges - model-reasoned connections that need verification._
- **Are the 27 inferred relationships involving `ServerRole.AssertGameServer()` (e.g. with `GameBoot.Start()` and `MatchArrival.Start()`) actually correct?**
  _`ServerRole.AssertGameServer()` has 27 INFERRED edges - model-reasoned connections that need verification._
